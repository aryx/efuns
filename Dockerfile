# Build efuns with OCaml 4.14.2 via OPAM on Ubuntu.
...
# Add external deps of efuns and its submodules
...
# efuns GUI needs cairo and gtk2
...
# or JS packages (cohttp-lwt, js_of_ocaml-lwt, semgrep.core) not needed by efuns.
