...
(* pad: This is a copy of genlex.ml from the stdlib (now camlp-streams)
 * because it was deprecated in recent OCaml and I removed it from
 * ocaml-light but options.ml in this file needs it
 *)
